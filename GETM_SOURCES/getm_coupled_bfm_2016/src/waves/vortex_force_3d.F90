...
!
! !INTERFACE:
   subroutine vortex_force_3d(veluEuler3d,velvEuler3d,hun,hvn,uuEx,vvEx)
!
! !DESCRIPTION:
!
! !USES:
...
!
! !INPUT PARAMETERS:
   REALTYPE,dimension(I3DFIELD),intent(in)    :: veluEuler3d,velvEuler3d,hun,hvn
!
...
!     KK-TODO: use of already calculated deformation rates...
      call deformation_rates(veluEuler3d(:,:,k),velvEuler3d(:,:,k),           &
