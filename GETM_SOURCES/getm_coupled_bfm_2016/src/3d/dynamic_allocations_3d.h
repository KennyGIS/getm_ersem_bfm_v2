  ...
  allocate(velu3d(I3DFIELD),stat=rc)    ! 3D field for u-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (velu3d)'

  allocate(velv3d(I3DFIELD),stat=rc)    ! 3D field for v-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (velv3d)'
  ...
  allocate(veluAdv(I2DFIELD),stat=rc)    ! 2D field for Uadv-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (veluAdv)'

  allocate(velvAdv(I2DFIELD),stat=rc)    ! 2D field for Vadv-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (velvAdv)'

  allocate(velxAdv(I2DFIELD),stat=rc)    ! 2D field for Uadv-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (velxAdv)'

  allocate(velyAdv(I2DFIELD),stat=rc)    ! 2D field for Vadv-velocity
  if (rc /= 0) stop 'init_3d: Error allocating memory (velyAdv)'
