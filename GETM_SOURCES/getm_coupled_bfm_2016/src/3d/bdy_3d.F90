...
! !PUBLIC DATA MEMBERS:
   ...
   REALTYPE,dimension(:,:),allocatable,public :: bdy_data_uu
   REALTYPE,dimension(:,:),allocatable,public :: bdy_data_vv
   REALTYPE,dimension(:,:),allocatable,public :: bdy_data_S
   REALTYPE,dimension(:,:),allocatable,public :: bdy_data_T
#ifdef _FABM_
...
#endif
   REALTYPE,dimension(:,:),pointer,contiguous :: p_bdy_data,p2d
   integer                                 :: i,j,l,n,o
#ifdef BFM_GOTM
!   integer                   :: bio_bounds,ib,ierror
   integer                   :: bio_bounds,ib,bio_bst
   integer :: i_bdy1,i_bdy2
!   REALTYPE                  :: S1D(0:kmax),T1D(0:kmax),R1D(0:kmax)
#endif
!EOP
!-----------------------------------------------------------------------
!BOC
...
!LEVEL1 'bdy_3d'
!LEVEL1 'bdy_index',bdy_index(:)
!LEVEL1 'cc3d_bdy',cc3d_bdy(3,24,:)
!LEVEL1 'bdy_data_S',bdy_data_S(24,:)
!stop
   l = 0
   do n=1,NWB
      l = l+1
...
!JM                  call bdy_3d_west(l,n,CLAMPED,cc3d(:,:,:,ib),cc3d_bdy(ib,:,bdy_index(l)))
                  bio_bst=bio_bst+1
                  i_bdy1=bdy_index(1)
                  i_bdy2=i_bdy1+nsbvl-1
                  bdy_data=cc3d_bdy(bio_bst,:,i_bdy1:i_bdy2)
!LEVEL1 'west ib,l,i_bdy1,i_bdy2',ib,l,i_bdy1,i_bdy2
!LEVEL1 'bdy_index',bdy_index
!LEVEL1 'nsbv,nsbvl',nsbv,nsbvl
!LEVEL1 'bdy_data',bdy_data(24,:)
!stop
!LEVEL1 'bdy_index(1)',bdy_index(1)
!LEVEL1 'S',S(1,:,24)
!LEVEL1 'S',S(2,:,24)
!LEVEL1 'S',S(3,:,24)
!LEVEL1 'S',S(4,:,24)
!LEVEL1 'before, CLAMPED, bdy_3d_type(l)',CLAMPED, bdy_3d_type(l)
!LEVEL1 'cc3d',cc3d(1,:,24,3)
!LEVEL1 'cc3d',cc3d(2,:,24,3)
!LEVEL1 'cc3d',cc3d(3,:,24,ib)
!LEVEL1 'cc3d',cc3d(4,:,24,3)
                  call bdy_3d_west(l,n,CLAMPED,cc3d(:,:,:,ib),bdy_data)
!LEVEL1 'l,n',l,n
!LEVEL1 'cc3d',cc3d(1,:,24,3)
!LEVEL1 'cc3d',cc3d(2,:,24,3)
!LEVEL1 'cc3d',cc3d(3,:,24,ib)
...
!JM                  call bdy_3d_north(l,n,CLAMPED,cc3d(:,:,:,ib),cc3d_bdy(ib,:,bdy_index(l)))
                  bio_bst=bio_bst+1
                  i_bdy1=bdy_index(1)    ! always pull the full boundary
                  i_bdy2=i_bdy1+nsbvl-1
                  bdy_data=cc3d_bdy(bio_bst,:,i_bdy1:i_bdy2)
!LEVEL1 'north ib,l,NOB,i_bdy1,i_bdy2',ib,l,NOB,i_bdy1,i_bdy2
!LEVEL1 'bdy_index',bdy_index
!LEVEL1 'nsbv,nsbvl',nsbv,nsbvl
!LEVEL1 'bdy_data_S',bdy_data_S(24,:)
!LEVEL1 'bdy_data',bdy_data(24,:)
!LEVEL1 'cc3d',cc3d(:,jmax,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-1,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-2,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-3,24,ib)
                  call bdy_3d_north(l,n,CLAMPED,cc3d(:,:,:,ib),bdy_data)
!LEVEL1 'cc3d',cc3d(:,jmax,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-1,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-2,24,ib)
!LEVEL1 'cc3d',cc3d(:,jmax-3,24,ib)
...
!JM                  call bdy_3d_east(l,n,CLAMPED,cc3d(:,:,:,ib),cc3d_bdy(ib,:,bdy_index(l)))
                  ...
                  i_bdy2=i_bdy1+nsbvl-1
                  bdy_data=cc3d_bdy(bio_bst,:,i_bdy1:i_bdy2)
!LEVEL1 'east ib,l,NOB,i_bdy1,i_bdy2',ib,l,NOB,i_bdy1,i_bdy2
!LEVEL1 'bdy_index',bdy_index
!LEVEL1 'nsbv,nsbvl',nsbv,nsbvl
!LEVEL1 'bdy_data',bdy_data(24,:)
...
! !INPUT VARIABLES:
   ...
   REALTYPE,intent(in),optional :: bdy_data(0:kmax,nsbvl)
!
...
!                    in spatial relaxation/sponge
                     f(i,j,1:kmax) = (_ONE_-rlxcoef(1:kmax))*bdyvert(1:kmax)/wsum + rlxcoef(1:kmax)*bdy_data(1:kmax,kl)
                  else
