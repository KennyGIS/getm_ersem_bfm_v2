...
! !USES:
   ...
   use variables_3d, only: velu3d=>veluEuler3d,velv3d=>velvEuler3d,hn,hun,hvn,SS,num
...
#ifdef SLICE_MODEL
   SS(imin:imax,j+1,:) = SS(imin:imax,j,:)
#endif
